...
| load-bearing _(metaphor)_               | essential, critical, necessary — or say what breaks if you remove it |
...
| deeply _(significance collocations only — "deeply integrated," "deeply committed," "deeply rooted"; literal uses like "deeply nested" or "cares deeply" never count toward a cluster)_ | cut, or name what specifically runs deep               |
...
offenders. Two rules apply: the same phrase used twice, and three or more _distinct_
