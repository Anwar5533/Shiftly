  ...
  return (
    <figure className="m-0">
      <div
        ...
        className="group border-border bg-dark relative aspect-[1200/660] -rotate-[1.1deg] cursor-ew-resize touch-none overflow-hidden rounded-[22px] border shadow-[0_30px_70px_rgba(23,21,20,0.22)] transition-transform duration-500 select-none [--wipe:50%] hover:rotate-0"
        onPointerDown={(e) => {
      ...
      >
        ...
        <div
          className="bg-gold-bright absolute top-0 bottom-0 z-20 w-0.5 -translate-x-px shadow-[0_0_0_1px_rgba(23,21,20,0.25)]"
          style={{ left: 'var(--wipe)' }}
        >
          <span className="bg-gold-bright absolute top-1/2 left-1/2 grid h-9 w-9 -translate-x-1/2 -translate-y-1/2 place-items-center rounded-full shadow-[0_20px_60px_rgba(23,21,20,0.18)] transition-transform group-hover:scale-110">
        ...
        <span
          className="text-ink absolute bottom-4 left-4 z-10 -rotate-3 rounded-md bg-[#f4f1eb] px-3 py-1 text-[1.05rem] font-bold shadow-[0_6px_16px_rgba(23,21,20,0.22)]"
          style={{ fontFamily: 'var(--font-hand)' }}
        >
          no skill
        </span>
        <span
          className="text-gold absolute right-4 bottom-4 z-10 rotate-2 rounded-md bg-[#f4f1eb] px-3 py-1 text-[1.05rem] font-bold shadow-[0_6px_16px_rgba(23,21,20,0.22)]"
          style={{ fontFamily: 'var(--font-hand)' }}
        >
          tastemaker
        </span>
