...
| Score | Standard                                                                       |
| ----- | ------------------------------------------------------------------------------ |
| 9–10  | Refreshing; finds a unique expression _within_ the chosen philosophy           |
...
❌ **Praise without specifics**: "looks great!" provides zero learning. Always say _what_ is great and _why_.
...
❌ **Critiquing without grounding**: every "Fix" should reference a principle (hierarchy, craft, philosophy, etc.) so the user understands the _why_, not just the _what_.
