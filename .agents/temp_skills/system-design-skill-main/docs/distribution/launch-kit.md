...
Release: <https://github.com/pinchen147/system-design-skill/releases/tag/v1.1.0>
...
7. Audit the implemented architecture against the intended one, and report the debt between them.
