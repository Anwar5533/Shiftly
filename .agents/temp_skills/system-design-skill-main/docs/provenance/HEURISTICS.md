...
| Claim                                                                                                          | Source                                                                                                       |
| -------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------ |
| W + R > N overlaps a **strict** quorum; a sloppy quorum uses the first N _healthy_ nodes and voids the overlap | https://www.allthingsdistributed.com/files/amazon-dynamo-sosp2007.pdf §4.5, §4.6                             |
...
**Rejected.** "~17 write TPS → sagas and two-phase commit are unjustified complexity" as a _causal_
