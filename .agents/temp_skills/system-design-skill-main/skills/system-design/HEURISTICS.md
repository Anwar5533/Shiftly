...
- A watermark is a heuristic claim that event time has passed _t_: too fast drops late data, too slow lets one straggler hold every result. State the lateness bound and where events past it go.
