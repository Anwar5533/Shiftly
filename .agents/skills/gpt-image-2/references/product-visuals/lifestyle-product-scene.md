...
```json
{
  ...
  "constraints": {
    "must_keep": ["商品是视觉焦点", "场景真实可信", "光线方向统一", "道具与商品同色系"],
    "avoid": ["场景看起来是 3D 渲染", "人物正脸抢戏", "道具喧宾夺主", "出现明显的电商广告卡片"]
  }
}
```
...
```json
{
  ...
  "scene": {
    "location": "海边木桌",
    "time_of_day": "晴朗午后",
    "extra_props": ["高脚杯 + 柠檬装饰", "近处水珠铝罐", "远处虚化海滩与天空"]
  },
  "lighting": {
    "type": "自然光",
    "direction": "顶光 + 闪光焦外",
...
```json
{
  ...
  "scene": {
    "location": "极简北欧风桌面",
    "time_of_day": "上午",
    "extra_props": ["笔记本电脑半开", "咖啡杯", "小植物", "翻开的笔记本"]
  },
  "lighting": {
    "type": "室内自然光 + 顶部柔光",
    "direction": "正面偏左",
