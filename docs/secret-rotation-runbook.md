...
2. In the environment configuration, assign the *old* secret to `JWT_PREVIOUS_SECRET` (if your authentication guard supports falling back to verify old tokens).
3. Assign the *new* secret to `JWT_SECRET`.
